    ...
    <div class="container">
        ...
        <form action="{{ route('kelas.store') }}" method="POST" style="max-width : 600px;">
            ...
            <div class="d-flex w-100 gap-2 mb-3" style="max-width: 600px;">
                ...
                <a href="{{ session('kelas_previous_url', route('kelas.index')) }}"
                    class="btn btn-secondary flex-grow-1">Kembali</a>
            </div>
        </form>
            ...
            <tbody>
                @foreach ($kelas as $kelasItem)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('kelas.edit', $kelasItem->id_kelas) }}" class="btn btn-sm btn-warning"
                                style="padding: 6px 20px; margin-right: 10px; color:white;">Edit</a>
                            <form action="{{ route('kelas.destroy', $kelasItem->id_kelas) }}" method="POST"
